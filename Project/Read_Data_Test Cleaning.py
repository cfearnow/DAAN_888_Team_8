# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 18:52:02 2022
...
# How mmany rows do we have before & after after cleaning?
len(meta_df)
len(review_df)
len(productreviews)
len(nonull_reviews)
...
# Check disto of overall or "star ratings"

plt.boxplot(nonull_reviews['overall'])
plt.ylabel("Number of Stars")
plt.tick_params(right = False, labelbottom= False, bottom = False)
plt.title("Star Ratings for Patio & Garden") # Change title to match dataset
plt.show()
